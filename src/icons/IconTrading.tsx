...
export function IconTrading(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width={24} height={24} viewBox='0 0 24 24' {...props}>
            ...
            <path
                ...
                opacity={0.7}
            ></path>
            <path fill='currentColor' d='M1.75 20.5a.75.75 0 0 0 0 1.5h20a.75.75 0 0 0 0-1.5z' opacity={0.5}></path>
        </svg>
    )
}
