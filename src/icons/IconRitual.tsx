...
export function IconRitual(props: SVGProps<SVGSVGElement>) {
    return (
...
export function IconRitualActivator(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={48} height={48} viewBox="0 0 48 48" {...props}>
            ...
            <path fill="currentColor" d="M0 0h48v48H0z" mask="url(#SVGkCcpxcEX)"></path>
        </svg>
    )
}
