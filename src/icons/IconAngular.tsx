    ...
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width='0.95rem' height='1rem' viewBox='0 0 260 260' {...props}>
            ...
            <path
                ...
                d='
                    m256 45.179l-9.244 145.158L158.373 0zm-61.217 187.697l-66.782 38.105l-66.784-38.105L74.8 199.958h106.4zM128.001 72.249l34.994 85.076h-69.99zM9.149 190.337L0 45.179L97.627 0z
                '
            ></path>
            <path
